...
DB2_DATASOURCE_ID = "Healthcare DB2 Database"  # Must match the title in register_db2_datasource()
DB2_HOST = "localhost"
DB2_PORT = 50000
            ...
            "steps": [
                ...
                # Step 2: Semantic Mapping to Healthcare Ontology
                {
                    ...
                    "config": {
                        ...
                        "mapping_mode": "auto",
                        "entity_uri": "http://healthcare.org/ontology#Patient"  # Enables ontology-driven loading with DDL auto-generation
                    }
                },
...
def main():
    ...
    print("=" * 60)
    print()
    csv_path, expected_unique, tracker = create_healthcare_data_with_tracking(10000)
