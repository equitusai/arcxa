        ...
        "definition": {
            "steps": [
                ...
                # Step 4: CSV Export
                {
                    ...
                    "depends_on": ["dedup"],
                    "config": {
                        "output_path": "/tmp/healthcare_deduped_100k.csv",
                        "include_header": True,
                    }
                }
            ]
...
def main():
    ...
    # Step 1: Generate 100K records with 20 fields
    print("\n" + "=" * 60)
    print("Step 1: Generate Synthetic Data (100K records, 20 fields)")
    print("=" * 60)
    csv_path, expected_unique = create_extended_healthcare_data(100000)
    ...
    print(f"  {'Total records:':<30} 100,000")
