...
#[utoipa::path(
    post,
    path = "/api/v1/governance/sparql",
    request_body = SparqlQuery,
    responses(
        (status = 200, description = "SPARQL query executed successfully", body = SparqlResults),
        (status = 400, description = "Invalid SPARQL query or query too complex", body = ApiErrorResponse),
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "RDF store statistics", body = RdfStats),
        (status = 500, description = "Internal server error", body = ApiErrorResponse),
    ),
    tag = "governance"
)]
...
#[utoipa::path(
    get,
    path = "/api/v1/governance/auto-save-stats",
    responses(
        (status = 200, description = "RDF auto-save statistics", body = RdfAutoSaveStatsResponse),
        (status = 500, description = "Internal server error", body = ApiErrorResponse),
    ),
    tag = "governance"
)]
...
#[utoipa::path(
    post,
    path = "/api/v1/governance/save",
    responses(
        (status = 200, description = "RDF save triggered successfully", body = RdfSaveResponse),
        (status = 500, description = "Internal server error", body = ApiErrorResponse),
    ),
    tag = "governance"
)]
